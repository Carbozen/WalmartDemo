              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div
                    ...
                    onClick={() =>
                      handleNavigationClick("/supplier/report", "Report")
                    }
                    style={{
                      backgroundColor:
                        activeTab === "Report"
                  ...
                  >
                    <div style={{ color: colors.textPrimary }}>
                      ...
                      >
                        <path
                          d="M224,88v120a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32H168Z"
                          opacity="0.2"
                        ></path>
          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="flex flex-wrap gap-4 px-4 py-6">
              ...
              >
                ...
                <p
                  className="tracking-light text-[32px] font-bold leading-tight truncate"
                  style={{ color: colors.textPrimary }}
                >
                  -10%
                </p>
                <div className="flex gap-1">
                  ...
                  <p
                    className="text-base font-medium leading-normal"
                    style={{ color: colors.negativeIndicator }}
                  >
                    -5%
                  </p>
                </div>
