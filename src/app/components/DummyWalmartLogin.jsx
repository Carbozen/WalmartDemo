...
const DummyWalmartLogin = () => {
  ...
  const colors = {
    ...
    positiveIndicator: "#078829",
    negativeIndicator: "#e72a08",
    borderColor: "#d1e6d9",
  };
            ...
            <div>
              ...
              <select
                ...
                style={{
                  ...
                  borderWidth: "1px",
                  "--focus-ring-color": colors.textSecondary,
                  backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='${encodeURIComponent(
                    colors.textPrimary
                  )}'%3e%3cpath fill-rule='evenodd' d='M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z' clip-rule='evenodd'%3e%3c/path%3e%3c/svg%3e")`,
